## rmf_visualization_msgs (lyrical) - 1.6.0-1

The packages in the `rmf_visualization_msgs` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical --edit-track rmf_visualization_msgs` on `Fri, 18 Sep 2026 08:58:28 -0000`
...
## rmf_visualization_msgs (rolling) - 1.5.0-1

The packages in the `rmf_visualization_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rmf_visualization_msgs` on `Tue, 18 Jun 2024 02:36:37 -0000`
...
## rmf_visualization_msgs (jazzy) - 1.4.1-1

The packages in the `rmf_visualization_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rmf_visualization_msgs` on `Mon, 17 Jun 2024 20:10:59 -0000`
...
## rmf_visualization_msgs (rolling) - 1.4.0-3

The packages in the `rmf_visualization_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rmf_visualization_msgs -y` on `Fri, 14 Jun 2024 21:56:37 -0000`
...
## rmf_visualization_msgs (iron) - 1.3.1-1
